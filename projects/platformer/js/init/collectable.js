(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 305, 6, 0);
        collectable.create(type.max, 600, 485, 6, 0);
        collectable.create(type.kennedi, 800, 175, 8, 0);
        collectable.create(type.grace, 100, 110, 5, 0); 
